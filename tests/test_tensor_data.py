...
def test_permute(data: DataObject) -> None:
    ...
    # print("permutation order", list(reversed(range(td.dims))))
    # print("ind", ind)
    # print("td shape",td._shape)
    # print("td stride",td._strides)
    # print("td pos",td.index(ind))
    # print("rev index",tuple(reversed(ind)))
    # print("td_rev shape",td_rev._shape)
    # print("td_rev stride",td_rev._strides)
    # print("td_rev pos on rev index",td_rev.index(tuple(reversed(ind))))
